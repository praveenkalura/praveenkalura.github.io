    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="about" className="relative min-h-[620px] overflow-hidden px-6 pt-28 pb-16 text-white lg:px-8">
        ...
        <div className="relative z-10 mx-auto flex min-h-[476px] max-w-7xl items-center">
          <div className="max-w-3xl rounded-lg bg-black/35 p-6 shadow-2xl backdrop-blur-[2px] md:p-8">
            <h1 className="mb-4 text-4xl font-bold leading-tight text-white md:text-5xl">{profileData.shortName}</h1>
            <div className="mb-6 max-w-2xl text-teal-50">
              <p className="text-xl font-semibold leading-8 md:text-2xl">{profileData.role}</p>
              {profileData.affiliation.map((line) => (
                <p key={line} className="text-base leading-7 md:text-lg">
                  {line}
                </p>
              ))}
            </div>
            <p className="mb-6 max-w-2xl text-base leading-8 text-gray-100 md:text-lg">{profileData.bio}</p>
                ...
                <Card key={edu.id} className="border-0 shadow-lg hover:shadow-xl transition-all group">
                  <CardContent className="p-8">
                    <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                      <div className="flex h-28 w-32 flex-shrink-0 items-center justify-center rounded-lg bg-gray-50 p-2 group-hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                      <div className="flex h-28 w-32 flex-shrink-0 items-center justify-center rounded-lg bg-gray-50 p-2 group-hover:bg-gray-100 transition-colors">
                        {exp.logo ? (
                          ...
                          <Briefcase size={56} className="text-gray-400" />
                        )}
                      </div>
                      <div className="min-w-0">
